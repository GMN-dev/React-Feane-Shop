        ...
        <footer>
            ...
            <div className="box-footer" id="f-section2">
                ...
                <div className="social-midias">
                    <a href="https://www.instagram.com/magalhaes.dev/" className="container-midia"><div ><i className="fa-brands fa-instagram"></i></div></a>
                    <a href="https://www.linkedin.com/in/gabriel-magalh%C3%A3es-b98a341ab/" className="container-midia"><div ><i className="fa-brands fa-linkedin-in"></i></div></a>
                    <a href="https://github.com/GMN-dev" className="container-midia"><div ><i className="fa-brands fa-github"></i></div></a>
                </div>
            </div>
